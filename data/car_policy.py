...
flags.DEFINE_string('output_path', 'ibc/ibc_logs/policy_eval/',
...
flags.DEFINE_enum('policy', None, [
    ...
    'oracle_push_normalized', 'particle_green_then_blue', 'car_oracles'
  ...
  if saved_model_path:
    ...
    if static_policy == 'random':
      policy = random_py_policy.RandomPyPolicy(env.time_step_spec(),
                                               env.action_spec())
    elif static_policy == 'car_oracles':
