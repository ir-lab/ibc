...
filename = "./ibc/data/quad_insert_v1/2d_oracle_particle_0.tfrecord"
spec_path = "./ibc/data/quad_insert_v1/2d_oracle_particle_0.tfrecord.spec"
...
output_path = './ibc/data/quad_insert_v1/quad_insert_spec.pbtxt'
